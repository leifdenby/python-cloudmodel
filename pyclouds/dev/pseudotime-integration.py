...
cloud_model = cloud_equations.FullThermodynamicsCloudEquations(gamma=gamma, D=D, beta=beta, environment=environment, microphysics=microphysics)
...
fig = plotting.plot_profiles(profiles, variables=['r', 'w', 'T', 'q_v', 'q_l', 'q_r'], initial_condition=initial_condition, labels_ncol=1)
